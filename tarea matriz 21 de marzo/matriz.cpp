...
//funcion para mostra el valor maximo 
...
//funcion para mostra el valor minimo
...
//funcion para mostra el promedio fila
...
//funcion para mostra el promedio columna
...
void invertir_Matriz(int matriz[5][4], int fila, int columna)
{
    ...
    for (int elemX = 0; elemX < fila; elemX++) // PONEMOS ELEMENTOSX Y ELEMENTOSY PARA PODER SELECCIONARLOS E INVERTIRLOS
    {
